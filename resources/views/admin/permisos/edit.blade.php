...
@section('content')
    <div class="ml-14 w-[calc(100%-80px)] absolute" style="font-family: 'poppins'">
        <div class="ml-3 w-full mt-2 h-12 bg-[#38BC9B] rounded-md flex justify-center items-center">
            <p class="text-white text-sm font-bold">EDITAR PERMISO</p>
        </div>
        <div class="flex justify-center">
            <div class="mx-3 mt-6 bg-white rounded-lg shadow-md p-6 max-w-2xl w-full border border-slate-400">
                <form action="{{ route('permisos.update', $permiso->idPermiso) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="nombrePermiso" name="nombrePermiso"
                    ...
                    <div class="mb-6 hidden">
                        ...
                        <textarea id="descripcion" name="descripcion" rows="4"
                            ...
                            placeholder="Descripción del permiso...">{{ old('descripcion', $permiso->descripcion) }}</textarea>
                        @error('descripcion')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <button type="submit"
                            ...
                            <i class="fa-solid fa-save mr-2"></i>Actualizar Permiso
                        </button>
