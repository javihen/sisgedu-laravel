...
@section('content')
    <div class="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
            ...
            <form action="{{ route('entrevistas.update', $entrevista->idEntrevista) }}" method="POST" id="entrevistaForm"
                class="space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <select name="idEstudiante" id="idEstudiante" required
                                ...
                                @foreach ($estudiantes as $estudiante)
                                    <option value="{{ $estudiante->id_estudiante }}"
                                        {{ $entrevista->idEstudiante == $estudiante->id_estudiante ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="number" name="idProfesor" id="idProfesor" required
                                value="{{ old('idProfesor', $entrevista->idProfesor) }}"
                        ...
                        <div>
                            ...
                            <input type="date" name="fecha" id="fecha" required
                                value="{{ old('fecha', $entrevista->fecha ? $entrevista->fecha->format('Y-m-d') : '') }}"
                        ...
                        <div>
                            ...
                            <input type="time" name="hora" id="hora" required
                                value="{{ old('hora', $entrevista->hora) }}"
                    ...
                    <div class="mt-6">
                        <label class="flex items-center space-x-3 cursor-pointer">
                            ...
                            <input type="checkbox" name="asistio" value="1"
                                {{ old('asistio', $entrevista->asistio) ? 'checked' : '' }}
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="observaciones" id="observaciones" rows="4"
                                ...
                                placeholder="Describa los temas tratados en la entrevista...">{{ old('observaciones', $entrevista->observaciones) }}</textarea>
                            @error('observaciones')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="acuerdos" id="acuerdos" rows="4"
                                ...
                                placeholder="Describa los acuerdos a los que llegaron...">{{ old('acuerdos', $entrevista->acuerdos) }}</textarea>
                            @error('acuerdos')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="pb-6">
                    ...
                    <div id="compromisosContainer" class="space-y-4">
                        ...
                        @forelse ($entrevista->compromisos as $compromiso)
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <textarea name="descripcion[]" rows="2" placeholder="¿Qué debe cumplirse?"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ $compromiso->descripcion }}</textarea>
                                    </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="date" name="fechaLimite[]"
                                            value="{{ $compromiso->fechaLimite ? $compromiso->fechaLimite->format('Y-m-d') : '' }}"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                    </div>
                                </div>
                            </div>
                        @empty
                            {{-- Compromiso inicial vacío si no hay compromisos --}}
                            <div class="compromiso-item bg-gray-50 border border-gray-200 rounded-lg p-6">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                    {{-- Descripción --}}
                                    <div class="md:col-span-2">
